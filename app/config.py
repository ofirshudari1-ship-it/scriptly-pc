...
DEFAULTS = {
    ...
    "auto_update_enabled": False,  # opt-in: silently download+install a newer release and relaunch (app/update_checker.py perform_self_update) - off by default since it closes the app to install
